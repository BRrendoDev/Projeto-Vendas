            ...
            <form method="post" action="php_action/Cad_user.php">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div id="barra" style="border:1px solid black;border-radius:10px 10px;  width:100px; height:10px;padding:5px;">
                        </div>
                        <span id="span"></span>
                ...
                <tr>
                    <td>
                        <center><button type="submit">Cadastrar</button> <a href="index.php"><button type="button" class="back">Voltar</button></a></center>
                    </td>
                </tr>
            </form>
        </table>
